...
source_dir = dict(
    image_dir=[
        '/media/yang/yanghp/实验版本/2/RGB/Train/xs/images_png/',
    ],
    mask_dir=[
        '/media/yang/yanghp/实验版本/2/RGB/Train/xs/masks_png/',
    ],
)
target_dir = dict(
    image_dir=[
        '/media/yang/yanghp/实验版本/2/RGB/Train/bj/images_png/',
    ],
    mask_dir=[
        '/media/yang/yanghp/实验版本/2/RGB/Train/bj/masks_png/',
    ],
)

test_target_dir = dict(
    image_dir=[
        r'D:\hzj\dataset\RGB/Test/Urban/images_png/',
    ],
)
