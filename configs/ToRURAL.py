...
source_dir = dict(
    image_dir=[
        r'D:\hzj\dataset\RGB/Train/xs/images_png/',
    ],
    mask_dir=[
        r'D:\hzj\dataset\RGB/Train/xs/masks_png/',
    ],
)
target_dir = dict(
    image_dir=[
        r'D:\hzj\dataset\RGB/Val/bj/images_png/',
    ],
    mask_dir=[
        r'D:\hzj\dataset\RGB/Val/bj/masks_png/',
    ],
)

test_target_dir = dict(
    image_dir=[
        r'D:\hzj\dataset\RGB/Test/Rural/images_png/',
    ],
)
