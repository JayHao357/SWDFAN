...
class CategoryAlign_Module(nn.Module):
    def __init__(self, num_classes=8, ignore_bg=False):
...
def ICR(inputs, multi_layer=False, ignore_bg=False):
    """
...
def CCR(source, target, multi_layer=False, ignore_bg=False):
    """
